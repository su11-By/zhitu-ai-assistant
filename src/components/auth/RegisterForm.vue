<template>
  <form class="auth-form" @submit.prevent="handleRegister">
    ...
    <div class="form-group">
      <label>密码</label>
      <input v-model="password" type="password" placeholder="至少8个字符，含字母和数字" autocomplete="new-password" />
    </div>
    <div class="form-group">
      <label>确认密码</label>
    ...
    <p class="switch-text">
      已有账号？<button type="button" class="link-btn" @click="$emit('switch')">去登录</button>
    </p>
  </form>
</template>
